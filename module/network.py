...
class Network(nn.Module):
    def __init__(
        ...
        self.input_img_channels = self.config.image_channels
        self.mask_channels =  self.config.n_classes
        self.self_condition = False
        self.image_size = network_config.max_patch_size
    ...
    def forward(self, seg, time, img,x_self_cond = None):
